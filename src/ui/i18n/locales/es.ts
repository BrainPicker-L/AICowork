...
export default {
	...
	help: {
		...
		quickStart: {
			title: "Inicio Rápido",
			description: "Aprenda a usar Agent Cowork para comenzar su primera tarea",
		},
		faq: {
	...
	app: {
		...
		startConversation: "Iniciar una conversación con Agent Cowork",
