...
export default {
	...
	help: {
		...
		quickStart: {
			title: "Incio Rpido",
			description: "Aprenda a usar o DtazziCowork para iniciar sua primeira tarefa",
		},
		faq: {
	...
	about: {
		title: "Sobre o DtazziCowork",
		subtitle: "Espao de Trabalho Colaborativo IA - DtazziCowork!",
		version: {
			title: "Verso",
		...
		tagline: "DtazziCowork torna a IA seu parceiro de trabalho colaborativo.",
	},
	...
	mcp: {
		...
		errors: {
			...
			invalidNameFormat: "O nome do servidor só pode conter letras, números, sublinhados e hífens",
			commandRequired: "O servidor tipo stdio deve especificar comando",
			urlRequired: "Este tipo de servidor deve especificar URL",
	...
	app: {
		...
		startConversation: "Iniciar uma conversa com o DtazziCowork",
