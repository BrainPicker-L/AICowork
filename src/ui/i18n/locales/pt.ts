...
export default {
	...
	help: {
		...
		quickStart: {
			title: "Início Rápido",
			description: "Aprenda a usar o Agent Cowork para iniciar sua primeira tarefa",
		},
		faq: {
	...
	app: {
		...
		startConversation: "Iniciar uma conversa com o Agent Cowork",
